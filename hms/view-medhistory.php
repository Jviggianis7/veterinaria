			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1>Usuario | Historial Medico de mis mascotas</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>usuarios</span>
							...
							<div class="col-md-12">
								...
								?>
									<table border="1" class="table table-bordered">
										...
										<tr>
											<th scope>Número de telefono</th>
									...
									<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										<tr align="center">
											<th colspan="8" style="font-size:20px;color:blue">Historial Medico de mis mascotas</th>
										</tr>
										<tr>
											<th>#</th>
