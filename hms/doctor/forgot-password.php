	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<a href="../../index.html">
					<h2 style="font-weight: 600;color: #000;"> EHEALT | Recuperar Contraseña Doctor</h2>
				</a>
			</div>

			<div class="box-login" style="background-color: white;">
				<form class="form-login" method="post">
					<fieldset>
						...
						<p>
							Introduzca su número de contacto y su dirección de correo electrónico para recuperar su contraseña.<br />
