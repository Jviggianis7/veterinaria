...
<body class="login" style="font-family:Poppins; background: url(../../images/imagen6.jpg) no-repeat center center fixed; background-size: cover; background-position: -200px -400px;">
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			...
			<div class="box-login" style="margin-top: 125px;">
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase">VETCOR </span>. <span>Todos Derechos Reservados 2024</span>
				</div>
