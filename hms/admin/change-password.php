...
if (isset($_POST['submit'])) {
	...
	if ($num > 0) {
		...
		$_SESSION['msg1'] = "la contraseña antigua no funciona !!";
	}
}
?>
<!DOCTYPE html>
	...
	<script type="text/javascript">
		function valid() {
			if (document.chngpwd.cpass.value == "") {
				...
				alert("La nueva contraseña esta vacía !!");
				document.chngpwd.npass.focus();
				return false;
			} else if (document.chngpwd.cfpass.value == "") {
				alert(" el campo Confirmar contraseña no está vacio!!");
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h2 style="font-weight: 600;color: #1369F5;">Admin | Cambiar contraseña</h2>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
